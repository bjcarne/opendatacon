...
{
public:
	CommandCallbackPromise(std::promise<ODC::CommandStatus> aPromise, std::function<void()> aCompletionHook = nullptr):
...
private:
	std::promise<ODC::CommandStatus> mPromise;
